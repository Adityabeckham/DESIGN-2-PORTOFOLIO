...
export const skillsData: SkillItem[] = [
  ...
  { name: 'Claude AI', icon: '/assets/images/skills/claudeai.png' },
  { name: 'ChatGPT', icon: '/assets/images/skills/chatgptai.png' },
  { name: 'Gemini', icon: '/assets/images/skills/geminiai.jpeg' },
  { name: '9Router', icon: '/assets/images/skills/9router_logo.webp' },
